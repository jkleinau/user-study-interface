...
const ImageAnnotator: React.FC<ImageAnnotatorProps> = ({ imageUrl, prompt }) => {
    ...
    return (
        <div className='flex bg-white p-8 rounded-lg shadow-lg space-x-2'>
            <div className={`relative w-[${dimensions.width}px] h-[${dimensions.width}px] cursor-crosshair`}>
                <canvas
                    ref={canvasRef}
                    ...
                    />
                <Image className='' src={imageUrl} alt={'Image to be anntoated'} width={dimensions.width} height={dimensions.height}/>
            ...
            <div className='w-[512px]'>
                <div className='bg-slate-300 p-4 rounded-lg shadow-lg mb-2'>
                    <h1 className='text-2xl underline mb-2'>Aufgabenstellung</h1>
                    <p className='text-wrap'>Markiere Bereiche, die hinzugefügt, entfernt oder geändert werden sollen</p>
                </div>
                <div className='bg-slate-300 p-4 rounded-lg shadow-lg mb-2'>
                ...
                <div className='bg-slate-300 p-4 rounded-lg shadow-lg mb-2'>
                    <h1 className='text-xl underline mb-2'>Werkzeuge</h1>
                    <div className='grid grid-cols-4 space-x-2'>
                        <p className='ml-2'>Add</p>
                        <p className='ml-2'>Remove</p>
                        <p className='ml-2'>Change</p>
                        <p className='ml-2'>Finish Polygon</p>
                        <Image src='/add.svg' alt='Add' width={24} height={24} />
                        <Image src='/remove.svg' alt='Remove' width={24} height={24} />
                        <Image src='/important.svg' alt='Change' width={24} height={24} />
                        <Image src='/enter.svg' alt='Finish' width={24} height={24} />
                    </div>
                </div>
            </div>
        </div>
